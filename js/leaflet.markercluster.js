...
!(function (e, t, i) {
  (L.MarkerClusterGroup = L.FeatureGroup.extend({
          ...
          _ = L.bind(function () {
            for (var d = new Date().getTime(); a > h; h++) {
              ...
              if (((t = e[h]), t instanceof L.LayerGroup))
                u && ((e = e.slice()), (u = !1)), this._extractNonGroupLayers(t, e), (a = e.length);
              else if (t.getLatLng) {
                if (
                  !this.hasLayer(t) &&
    ...
    _zoomOrSpiderfy: function (e) {
      ...
      i._zoom === this._maxZoom && i._childCount === t._childCount && this.options.spiderfyOnMaxZoom
        ? t.spiderfy()
    ...
    L.Marker.include({
      clusterHide: function () {
        return (
          (this.options.opacityWhenUnclustered = this.options.opacity || 1), this.setOpacity(0)
        );
      },
