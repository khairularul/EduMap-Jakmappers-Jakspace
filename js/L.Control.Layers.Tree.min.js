  ...
  L.Control.Layers.Tree = L.Control.Layers.extend({
    ...
    expandSelected: function (overlay) {
      function iter(el) {
        ...
        if (p) {
          if (
            L.DomUtil.hasClass(p, that.cls.children) &&
    ...
    _iterateTreeLayout: function (tree, container, overlay, selAllNodes, noShow) {
      ...
      if (tree.layer) {
        if (
          this.options.labelIsSelector === "both" ||
          (overlay && this.options.labelIsSelector === "overlay") ||
          ...
          if (obj) {
            L.DomEvent.on(
              ...
              (function (selectAll) {
                return function (ev) {
                  ev.stopPropagation();
                  var select = isFunction(selectAll)
                    ? selectAll(ev, container, tree, this._map)
                    : selectAll;
